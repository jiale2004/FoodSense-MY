...
- `training_scripts/ingest_curated_images.py` (new incremental curated ingest)
- `training_scripts/scrape_images.py` (tighter Mee Goreng query variants)
- `tests/test_ingest_curated_images.py`
- `README.md`
